        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="pinjam.php" method="POST">
                          ...
                          <div class="text-kanan" style="float: left; margin-left: 18%; width: 83%; margin-top:-65px;">
                              <p class="card-text"  >No Handphone : <select name="jenis" id="borrow"  aria-label="Default select example" >
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" name="pnjm">Submit</button>
                          </div>
              </form>
                  </div>
            </div>
           ...
           <ul class="pagination justify-content-end">
            <li class="page-item">
              <a class="page-link" href="acer.php">Previous</a>
            </li>
             ...
             <li class="page-item">
                <a class="page-link" href="lainnya.php">Next</a>
             </li>
             </ul>
          </nav>  
