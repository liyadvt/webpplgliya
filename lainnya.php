                ...
                <div class="card" style="margin: 15px; width: 11.5rem; ">
                                <div class="card-body" style="text-align: center; float: left;">
                                  ...
                                  <div class="text-kanan">
                                      <p class="card-title">No Tablet :1</p>
                          ...
                          <div class="card" style="margin: 15px; width: 11.5rem; ">
                                <div class="card-body" style="text-align: center; float: left;">
                                  ...
                                  <div class="text-kanan">
                                      <p class="card-title">No Tablet : 2</p>
                                      <p class="card-text">Status : baik</p>                                        
                                  </div>
                            </div>
                          </div>
                          ...
                          <div class="card" style="margin: 15px; width: 11.5rem; ">
                                ...
                                tablet
                                  ...
                                  <div class="text-kanan">
                                      <p class="card-title">No Tablet : 3</p>
                                      <p class="card-text">Status : baik</p>                                        
                                  </div>
                                  <div class="text-kiri">
                        ...
                        <div class="card" style="margin: 15px; width: 11.5rem; ">
                                ...
                                tablet
                                  ...
                                  <div class="text-kanan">
                                      <p class="card-title">No Tablet : 4</p>
                                      <p class="card-text">Status : baik</p>                                        
                                  </div>
                              </div>
                          </div>
      ...
      <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="pinjam.php" method="POST">
                          ...
                          <div class="text-kanan" style="float: left; margin-left: 18%; width: 83%; margin-top:-65px;">
                              <p class="card-text"  >No Tablet : <select name="jenis" id="borrow"  aria-label="Default select example" >
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" name="brw">Submit</button>
                          </div>
              </form>
                  </div>
            </div>
           ...
           <li class="page-item">
              <a class="page-link" href="hp.php">Previous</a>
            </li>
